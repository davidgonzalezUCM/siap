...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* PROPS */
  , ["value", "hour-options", "disabled-date"])])]), _hoisted_15]), _hoisted_17])])]), _hoisted_18], 64
  /* STABLE_FRAGMENT */
  );
}
